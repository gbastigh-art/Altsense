...
/*
    ...
    Cmdline:
        sokol-shdc --input src/shader/screenquad.glsl --output src/shader/screenquad.glsl.h --slang metal_macos --format=sokol_impl -r

    Overview:
    =========
    Shader program: 'program':
        Get shader desc: screenquad_program_shader_desc(sg_query_backend());
        Vertex shader: vs
            Attributes:
        ...
        Fragment shader: fs
            Uniform block 'fs_params':
                C struct: screenquad_fs_params_t
                Bind slot: SLOT_screenquad_fs_params => 0
            Image 'tex':
...
#endif
#endif
const sg_shader_desc* screenquad_program_shader_desc(sg_backend backend);
int screenquad_program_attr_slot(const char* attr_name);
int screenquad_program_image_slot(sg_shader_stage stage, const char* img_name);
int screenquad_program_sampler_slot(sg_shader_stage stage, const char* smp_name);
int screenquad_program_uniformblock_slot(sg_shader_stage stage, const char* ub_name);
size_t screenquad_program_uniformblock_size(sg_shader_stage stage, const char* ub_name);
int screenquad_program_storagebuffer_slot(sg_shader_stage stage, const char* sbuf_name);
int screenquad_program_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name);
sg_shader_uniform_desc screenquad_program_uniform_desc(sg_shader_stage stage, const char* ub_name, const char* u_name);
#define ATTR_screenquad_vs_position (0)
#define ATTR_screenquad_vs_texcoord0 (1)
#define SLOT_screenquad_vs_params (0)
#define SLOT_screenquad_fs_params (0)
...
#pragma pack(pop)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct screenquad_fs_params_t {
    v4 tint;
    f32 transparency;
    uint8_t _pad_20[12];
} screenquad_fs_params_t;
#pragma pack(pop)
...
*/
static const uint8_t screenquad_vs_source_metal_macos[595] = {
...
/*
    ...
    fragment main0_out main0(main0_in in [[stage_in]], constant fs_params& _30 [[buffer(0)]], texture2d<float> tex [[texture(0)]], sampler smp [[sampler(0)]])
    {
        main0_out out = {};
        out.frag_color = tex.sample(smp, in.uv);
        float4 _26 = out.frag_color;
        float3 _43 = mix(_26.xyz, _30.tint.xyz, float3(_30.tint.w));
        out.frag_color.x = _43.x;
        out.frag_color.y = _43.y;
        out.frag_color.z = _43.z;
        out.frag_color.w *= (1.0 - _30.transparency);
        return out;
    }

*/
static const uint8_t screenquad_fs_source_metal_macos[732] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x20,0x74,0x72,0x61,0x6e,0x73,0x70,0x61,0x72,0x65,0x6e,
    0x63,0x79,0x3b,0x0a,0x7d,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,0x6d,
    ...
    0x33,0x30,0x20,0x5b,0x5b,0x62,0x75,0x66,0x66,0x65,0x72,0x28,0x30,0x29,0x5d,0x5d,
    ...
    ,
...
const sg_shader_desc* screenquad_program_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_METAL_MACOS) {
        ...
        if (!valid) {
            valid = true;
            desc.vs.source = (const char*)screenquad_vs_source_metal_macos;
            desc.vs.entry = "main0";
            desc.vs.uniform_blocks[0].size = 192;
            desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
            desc.fs.source = (const char*)screenquad_fs_source_metal_macos;
            desc.fs.entry = "main0";
            ...
            desc.label = "screenquad_program_shader";
        }
        return &desc;
    }
    return 0;
...
size_t screenquad_program_uniformblock_size(sg_shader_stage stage, const char* ub_name) {
    ...
    if (SG_SHADERSTAGE_VS == stage) {
        if (0 == strcmp(ub_name, "vs_params")) {
            return sizeof(screenquad_vs_params_t);
        }
    }
    if (SG_SHADERSTAGE_FS == stage) {
        if (0 == strcmp(ub_name, "fs_params")) {
            return sizeof(screenquad_fs_params_t);
        }
    }
    return 0;
}
int screenquad_program_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name) {
    ...
    if (SG_SHADERSTAGE_FS == stage) {
        if (0 == strcmp(ub_name, "fs_params")) {
            if (0 == strcmp(u_name, "tint")) {
                return 0;
            }
            if (0 == strcmp(u_name, "transparency")) {
                return 16;
            }
        }
    }

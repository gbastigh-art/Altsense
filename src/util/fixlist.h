...
// get total capacity of fixlist
#define fixlist_capacity(_d) (ARRLEN((_d).arr))
...
// get index of pointer p in fixlist
...
void *_fixlist_insert_sorted_impl(
    ...
    void *ptr = _fixlist_insert_impl(data, n, t_size, cap, low);
    memcpy(ptr, val, t_size);
    return ptr;
}

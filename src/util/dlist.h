...
void *_dlist_pop_impl(void *_list, int offset);
...
// pops from end of dlist
#define dlist_pop(_field, _plist)                          \
    ((typeof((_plist)->head))                              \
        (_dlist_pop_impl(                                  \
            (_plist),                                      \
            offsetof(typeof(*((_plist)->head)), _field)))) \
...
void *_dlist_pop_impl(void *_list, int offset) {
    ...
    ASSERT(p);
    _dlist_remove_impl(_list, p, offset);
